    ...
    public class TestCopying
    {
            ...
            : Aas.Visitation.AbstractTransformerWithContext<Aas.IClass, bool>
        {
                ...
                Aas.IClass other)
            {
                ...
                return (
                    ...
                    && (that.LevelType != null && casted.LevelType != null)
                        ? that.LevelType == casted.LevelType
                        : that.LevelType == null && casted.LevelType == null);
            }
                ...
                Aas.IClass other)
            {
                ...
                return (
                    that.UnitName == casted.UnitName
                    && that.UnitSymbol == casted.UnitSymbol
                    && that.Definition.Count == casted.Definition.Count
                    && (
                        that.Definition
                            .Zip(
                                ...
                                Transform)
                            .All(item => item))
                    && that.SiNotation == casted.SiNotation
                    && that.SiName == casted.SiName
                    && that.DinNotation == casted.DinNotation
                    && that.EceName == casted.EceName
                    && that.EceCode == casted.EceCode
                    && that.NistName == casted.NistName
                    && that.SourceOfDefinition == casted.SourceOfDefinition
                    && that.ConversionFactor == casted.ConversionFactor
                    && that.RegistrationAuthorityId == casted.RegistrationAuthorityId
                    && that.Supplier == casted.Supplier);
            }
        }  // internal class DeepEqualsier
            ...
            Aas.Entity other)
        {
            return (
                ...
                && that.GlobalAssetId == other.GlobalAssetId
                && that.SpecificAssetId == other.SpecificAssetId);
        }
        ...
        private static bool DataSpecificationPhysicalUnitShallowEquals(
            Aas.DataSpecificationPhysicalUnit that,
            Aas.DataSpecificationPhysicalUnit other)
        {
            return (
                that.UnitName == other.UnitName
                && that.UnitSymbol == other.UnitSymbol
                && that.Definition == other.Definition
                && that.SiNotation == other.SiNotation
                && that.SiName == other.SiName
                && that.DinNotation == other.DinNotation
                && that.EceName == other.EceName
                && that.EceCode == other.EceCode
                && that.NistName == other.NistName
                && that.SourceOfDefinition == other.SourceOfDefinition
                && that.ConversionFactor == other.ConversionFactor
                && that.RegistrationAuthorityId == other.RegistrationAuthorityId
                && that.Supplier == other.Supplier);
        }
        ...
        private static bool DataSpecificationPhysicalUnitDeepEquals(
            Aas.DataSpecificationPhysicalUnit that,
            Aas.DataSpecificationPhysicalUnit other)
        {
            return DeepEqualsierInstance.Transform(that, other);
        ...
        [Test]
        public void Test_DataSpecificationPhysicalUnit_shallow_copy()
        {
            ...
            Assert.IsTrue(
                DataSpecificationPhysicalUnitShallowEquals(
                    instance, instanceCopy),
                "DataSpecificationPhysicalUnit");
        }  // public void Test_DataSpecificationPhysicalUnit_shallow_copy

        [Test]
        public void Test_DataSpecificationPhysicalUnit_deep_copy()
        {
            Aas.DataSpecificationPhysicalUnit instance = (
                Aas.Tests.CommonJsonization.LoadCompleteDataSpecificationPhysicalUnit());
            ...
            Assert.IsTrue(
                DataSpecificationPhysicalUnitDeepEquals(
                    instance, instanceCopy),
                "DataSpecificationPhysicalUnit");
        }  // public void Test_DataSpecificationPhysicalUnit_deep_copy
